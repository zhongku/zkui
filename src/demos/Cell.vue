  ...
  <div>
    ...
    <group :title="$t('Use is-link to show arrow')">
      ...
      <cell :title="$t('General')" is-link>
        <img slot="icon" width="20" style="display:block;margin-right:5*@rem;" src="data:image/png;base64,">
      </cell>
    </group>
