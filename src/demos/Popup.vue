<template>
  <div>
    ...
    <div v-transfer-dom>
      <popup v-model="show7" height="270*@rem" is-transparent>
        <div style="width: 95%;background-color:#fff;height:250*@rem;margin:0 auto;border-radius:5*@rem;padding-top:10px;">
          <group>
