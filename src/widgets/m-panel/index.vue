    ...
    <div class="weui-panel__bd">
      <slot name="body">
        ...
        <template v-if="type === '1'">
          <a :href="getUrl(item.url)" v-for="item in list" :key="item" @click.prevent="onItemClick(item)" class="weui-media-box weui-media-box_appmsg">
        ...
        <template v-if="type === '2'">
          <div class="weui-media-box weui-media-box_text" v-for="item in list" :key="item" @click.prevent="onItemClick(item)">
            <h4 class="weui-media-box__title" v-html="item.title"></h4>
            <p class="weui-media-box__desc" v-html="item.desc"></p>
          </div>
        </template>
        ...
        <template v-if="type === '3'">
          <div class="weui-media-box weui-media-box_small-appmsg">
            <div class="weui-cells">
              <a class="weui-cell weui-cell_access" :href="getUrl(item.url)" v-for="item in list" :key="item" @click.prevent="onItemClick(item)">
...
<script>
import { go, getUrl } from 'src/service/libs/router'
