<template>
  <div class="vux-form-preview weui-form-preview">
    ...
    <div class="weui-form-preview__ft">
      <a class="weui-form-preview__btn" :class="{'weui-form-preview__btn_default': button.style==='default', 'weui-form-preview__btn_primary': button.style === 'primary'}" href="javascript:" v-for="button in footerButtons" :key="button" @click="onButtonClick(button.onButtonClick, button.link)">{{(button.text)}}</a>
    </div>
  </div>
</template>
