    ...
    <div v-transfer-dom="isTransferDom">
      ...
      :popup-style="popupStyle">
        <div class="vux-popup-picker-container">
          <div class="m-popup-size">
            <h2>商品参数</h2>
            <div class="m-popup-size-content">
              <m-label title="123" inline-desc="456"></m-label>
            </div>
            <div class="m-popup-size-bottom">
              <m-button  type="primary" action-type="button" @click.native="onHide(true)" >关闭</m-button>
            </div>
          </div>
        </div>
      </popup>
...
.m-popup-size{
  ...
  .m-popup-size-content label.vux-label,span.vux-label-desc{
    text-align: left;
    font-size:0.65rem !important;
  }
  .m-popup-size-content div.weui-cell{
    border:1px solid rgba(229,229,229,.4)
  }
  .m-popup-size-bottom{
    position: absolute;
