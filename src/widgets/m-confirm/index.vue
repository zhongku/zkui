  ...
  <div class="vux-confirm">
    <x-dialog
      ...
      <div class="weui-dialog__ft">
        <a href="javascript:;" class="weui-dialog__btn weui-dialog__btn_default" @click="_onCancel">{{cancelText || ('cancel_text')}}</a>
        <a href="javascript:;" class="weui-dialog__btn" :class="`weui-dialog__btn_${confirmType}`" @click="_onConfirm">{{confirmText || ('confirm_text')}}</a>
      </div>
    </x-dialog>
  </div>
</template>
