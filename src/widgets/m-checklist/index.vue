<template>
  <div :class="disabled ? 'vux-checklist-disabled' : ''">
    ...
    <div class="weui-cells weui-cells_checkbox">
      <label class="weui-cell weui-check_label" :class="{'vux-checklist-label-left': labelPosition === 'left'}" :for="`checkbox_${uuid}_${index}`" v-for="(one, index) in currentOptions" :key="(one, index)">
        ...
        <div class="weui-cell__bd">
          ...
          <m-inline-desc v-if="getInlineDesc(one)">{{ getInlineDesc(one) }}</m-inline-desc>
        </div>
      </label>
    </div>
...
<script>
import Base from 'src/service/libs/base'
import Tip from '../m-tip'
