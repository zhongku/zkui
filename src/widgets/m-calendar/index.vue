    ...
    <div v-transfer-dom="shouldTransferDom">
      <popup
        ...
        <popup-header
          ...
          :right-text="('confirm_text')"></popup-header>
...
<script>
import InlineCalendar from '../m-inline-calendar'
import Popup from '../m-popup'
import Cell from '../m-cell'
import props from '../m-inline-calendar/props'
import TransferDom from 'src/service/directives/transfer-dom'
import PopupHeader from '../m-popup-header'
import format from 'src/service/tools/date/format'
