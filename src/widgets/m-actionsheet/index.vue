  ...
  <div class="vux-actionsheet">
      ...
      <transition name="vux-android-actionsheet">
        <div class="weui-actionsheet" v-show="show">
          <div class="weui-actionsheet__menu">
            <div class="weui-actionsheet__cell" v-for="(text, key) in menus" :key="(text, key)" @click="
    ...
    <div class="weui-actionsheet" :class="{'weui-actionsheet_toggle': show}" v-else>
      <div class="weui-actionsheet__menu">
        ...
        <div class="weui-actionsheet__cell" v-for="(text, key) in menus" :key="(text, key)" @click="onMenuClick(text, key)" v-html="(text.label || text)" :class="`vux-actionsheet-menu-${text.type || 'default'}`">
        </div>
      </div>
